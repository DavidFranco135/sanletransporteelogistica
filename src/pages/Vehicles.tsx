...
import { Plus, Search, Car, Calendar, Hash, X, Camera, Palette, Loader2 } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-sm font-bold text-slate-400">
                    Foto do Veículo <span className="text-slate-600 font-normal">(opcional)</span>
                  </label>
