    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <select className="bg-[#1e293b] border border-slate-700 rounded-lg px-4 py-2 text-sm font-medium outline-none focus:ring-2 focus:ring-emerald-500 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard 
          ...
          value={`R$ ${stats.expenses.toLocaleString()}`} 
          icon={TrendingDown} 
          trend="down" 
          trendValue="5%" 
          color="bg-red-600"
